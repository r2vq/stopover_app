...
void main() {
  test('should convert from json string to list of POIs', () {
    ...
    expect("https://firebasestorage.googleapis.com/v0/b/stopover-app-api.appspot.com/o/pois%2Fdummy_map.png?alt=media&token=a2b73ddf-ce0f-46b0-8206-932ab2f4b9b6", poiList[0].mapUrl);
